  ...
  try 
  {
    ...
    else
    {
      ...
      if (array_key_exists('E_MENSAJE', $decoded["SapZmfCommx1030Generaxmlportal"])) 
      {
        ...
        if (strpos($stringMensaje, 'devolucion de todos los articulos') || strpos($stringMensaje, 'Ticket sin artículos pendientes'))
        {
          echo $stringMensaje;
        }
        else
        {
          ...
          {
            //echo $stringMensaje . "aocegueda 1";
            //echo "aocegueda 1";
          }
          ...
          else
          {
            ...
            echo "<br><h1><b>Artículos</b></h1></br>";
