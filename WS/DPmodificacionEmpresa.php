...
#Variables POST
    ...
    $Ciudad=$_POST["Ciudad"];
    $fechaactual = getdate();
    $FENAC = "$fechaactual[mday]/$fechaactual[mon]/$fechaactual[year]";
#Variables POST
...
require_once 'Login/wsfacturacion.php';
     ...
     $SapZbapisd26ModifEmpresa="SapZbapisd26ModifEmpresa";
     $decoded=$SapZbapisd26ModifEmpresa($AKONT,$Sexo,$ANTLF,$BZIRK,$EstadoCivil,$Email,$Pais,$IDC,$KTGRD,$KZAZU,$Nombre,$ApellidoP,$NumeroEx,$NUMINT,$RFC,$LPRIO,$Telefono,$TIPO_CLIENTE,$Ciudad,$Distrito,$PRFRE,$CP,$Region,$SPART,$Calle,$VKORG,$VERSG,$VSBED,$VTWEG,$FENAC);
