<?php
    ...
    try //inicia Facturacion Dp
    {
        ...
        else 
        {
            ...
            //echo 'xml Dp: <pre>', htmlentities($string), '</pre>';
                            ...
                            foreach ($xml->xpath('//cfdi:Comprobante//cfdi:CfdiRelacionados//cfdi:CfdiRelacionado') as $CFDIRelacionado) 
                            {
                                ...
                                if (strlen($relacionado) > 1) 
                                {
                                    ...
                                    foreach ($xml->xpath('//cfdi:Comprobante') as $cfdiComprobante) 
                                    {
                                        ...
                                        //echo "Fecha Nueva: " . $nuevafecha;
                                        echo "Fecha XML: " . $cfdiComprobante['Fecha'];
                                    ...
                                    if ($i == 1) //Factura Ingreso
                                    {
                                        ...
                                        {
                                            //echo "Ticket: " . $Ticket;
                                            //echo 'Xml Dp <pre>', htmlentities($xmlstring), '</pre>';
                                            //echo 'Ingreso <pre>', htmlentities($xmlstring), '</pre>';
                                            ...
                                            //echo "Resultado Ingreso: " . $result;
                                            //echo 'XML Pack <pre>', htmlentities($xmr), '</pre>';
                                        } 
                                        catch (Exception $e) 
                                        {
                                    ...
                                    if (strlen($relacionado) > 1) 
                                    {
                                        ...
                                        if ($i == 1) {
                                            ...
                                            if ($paso == 0) {
                                                ...
                                                <strong>ERROR!1</strong> para poder realizar tu factura deberás esperar <b>24 hrs</b> 
                                                después de tu fecha de compra, Cualquier duda o aclaración favor de comunicarse al 
                                                66 99 15 53 00.</div>';
                                                /*echo '
                                                    <div class="alert alert-danger alert-dismissable fade in">
                                                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                        <strong>ERROR!</strong> para poder realizar tu factura deberás esperar <b>24 hrs</b> después de tu fecha de compra, Cualquier duda o aclaración favor de comunicarse al 66 99 15 53 00.</div>';*/
                                                $paso++;
                                            }
                                            break;
                                            return;
