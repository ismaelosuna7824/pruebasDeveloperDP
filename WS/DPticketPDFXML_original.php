...
if ($i==2) {
  ...
  #Datos para el PDF                   
          ...
          $decodeds = $SapZmfCommx1033FactPortal($Ticket,$documento,$UUID,$TimbradoFecha);
         /* if ($i==1) {
            $superString .= " PRIMERO: ".$Ticket."/ ".$documento." / ".$UUID." / ".$TimbradoFecha[0]." / ".$TimbradoFecha[1];
            $documento = "Cambio1";
            $UUID = "Cambio1";
            $TimbradoFecha[0] = "Cambio1";
            $TimbradoFecha[1] = "Cambio1";
            $superString .= " CAMBIO DE VALORES 1: ".$Ticket."/ ".$documento." / ".$UUID." / ".$TimbradoFecha[0]." / ".$TimbradoFecha[1];

        }
          if ($i==2) {
            $superString .= " SEGUNDO ".$Ticket."/ ".$documento." / ".$UUID." / ".$TimbradoFecha[0]." / ".$TimbradoFecha[1];
            $documento = "Cambio2";
            $UUID = "Cambio2";
            $TimbradoFecha[0] = "Cambio2";
            $TimbradoFecha[1] = "Cambio2";
            $superString .= " CAMBIO DE VALORES 2: ".$Ticket."/ ".$documento." / ".$UUID." / ".$TimbradoFecha[0]." / ".$TimbradoFecha[1];
            echo "QUE PEDO".$superString;
            die();
          }*/
