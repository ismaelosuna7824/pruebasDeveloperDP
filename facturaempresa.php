<?php session_start(); 
    ...
    $f = fopen("logs/logContador.txt","a");
        fputs($f,"FacturacionEmpresa"."\r\n") or die("no se pudo crear o insertar el fichero");
    fclose($f);
if (isset($_SESSION["RFC"])) {
    $POSRFC=$_SESSION["RFC"];
    require_once("./WS/DPconsultaempresa.php");
}else if (isset($_SESSION["empresarfc"])) {
    $POSRFC=$_SESSION["empresarfc"];
    require_once("./WS/DPconsultaempresa.php");
}else{
...
<head>
 ...
 <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" >
  ...
  <script Language=Javascript SRC="js/facturaempresa.js"></script>
    ...
    <div id="form" class="main-login main-center">
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2 center">
          <span class="titulo-formulario">INFORMACIÓN EMPRESA</span>
        </div> 
      </div>
      <hr>
      <div class="row rb-20">
        ...
        <div class="col-lg-3">
          <span id="apep"> Continuación Razón Social: </span>
        ...
        <!--
          <div class="col-lg-3">
            ...
            <input class="form-control" id="ApellidoM" type="text" name="ApellidoM" maxlength="60" value="">
          </div>
        -->
        <div class="col-lg-3">
          Calle:
        ...
        <div class="col-lg-2" style="display: none;">
          ...
          <!-- <input class="form-control" id="EstadoCivil" type="text" name="EstadoCivil" value="<?php echo $EstadoCivil ?>">-->
        </div>   
        <!-- 
          <div class="col-lg-3">
              Fecha de Creación:
