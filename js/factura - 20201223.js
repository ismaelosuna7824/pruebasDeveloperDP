    ...
    /*$("#MetodoPago").on("change",function(){
              ...
              $("#GenerarFactura").click(function() { 
                                  $.ajax({
                                      ...
                                      success: function (data) {
                                        formDefault();
                                        $("#MostrarTicket").hide();
                                        $("#MostrarTicketFacturados").html(data);
                                        $("#cerrarmodal").click();
                                        $("#email").click(function() { 
                                                 $.ajax({
                                                    url: './WS/DPPDFXMLEmail.php',
                                                    data: {Zip: $("#zip").val(),namezip: $("#namezip").val(), Nombre: $("#Nombre").val(), ApellidoP: $("#ApellidoP").val(), ApellidoM: $("#ApellidoM").val(), Email: $("#Email").val()},
                                                    type: "POST",
                                                    beforeSend: function () {
                                                                formDefault();
                                                                $("#modal").click();
                                                    ...
                                                    success: function (data) {
                                                                ...
                                                                $("#respuesta").html(data);
                                                                $("#cerrarmodal").click();
                                                                window.location.href = "#MostrarTicketFacturados";
                                                    },
                                                    error: function(data) {
                                                                $("#cerrarmodal").click();
      ...
      if (Modificar==0) {
        ...
        if($("#Nombre").val()==""){
          ...
          if($("#ApellidoM").val()==""){
            $("#ApellidoM").css({"border-style": "solid", "border-color": "red","border-width":"1px"});
            window.location.href = "#ApellidoM";
            return;
        }
          if($("#NumeroEx").val()==""){
        ...
        if($("#EstadoCivil").val()==""){
            $("#EstadoCivil").css({"border-style": "solid", "border-color": "red","border-width":"1px"});
