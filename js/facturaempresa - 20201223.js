                                        ...
                                        $("#cerrarmodal").click();
                                                       ...
                                                       $("#email").click(function() { 
                                                              $.ajax({
                                                                  ...
                                                                  data: {Pdf: $("#pdf").val(),Xml: $("#xml").val(),namexml: $("#namexml").val(), namepdf: $("#namepdf").val(), Nombre: $("#Nombre").val(), ApellidoP: $("#ApellidoP").val(), ApellidoM: $("#ApellidoM").val(), Email: $("#Email").val()},
                                                                  type: "POST",
                                                                   beforeSend: function () {
                                                                       formDefault();
                                                                       $("#modal").click();
